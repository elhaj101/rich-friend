...
// Persistent "reach your shopper" affordance, fixed to the bottom corner.
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      aria-label={t.dashWhatsapp}
      title={t.dashWhatsapp}
      className="fixed bottom-6 z-40 flex items-center gap-2.5 bg-whatsapp rounded-full shadow-lg pl-3.5 pr-4 py-3 no-underline hover:brightness-110 transition-all duration-200"
      style={{ insetInlineEnd: "1.5rem" }}
    >
      <WhatsAppIcon />
      <span className="hidden sm:inline font-sans font-semibold text-[12px] leading-none text-charcoal">
        {t.dashWhatsapp}
      </span>
    </a>
  );
